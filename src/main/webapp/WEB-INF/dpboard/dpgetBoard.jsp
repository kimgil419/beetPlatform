...
<section id="tabs" class="project-tab">
	...
	<thead>
		...
		<tr>
			...
			<img class="fancy"  style="display: ${(board.t_password == null) ? 'none':'' };" src ="${pageContext.request.contextPath}/image/${board.t_img}" width="500px;" height="350px;" alt="boardImage"> </div> <!-- $는 .equals는 반응하지 않는다 'null'은 안된다 -->
					<p>
					${board.t_content}
			</td>
		</tr>
