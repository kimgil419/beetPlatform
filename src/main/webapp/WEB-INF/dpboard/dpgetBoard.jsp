...
<div id="container">
	...
	<p>
		...
		<a href="dpdeleteBoards.do?seq=${board.seq }&curPage=${c1 }" ${(board.user_id == user_id) ? '':'hidden' }>글삭제</a>&nbsp;&nbsp;
...
<%--댓글 입력 폼 --%>
<form method="post" action="dpinsertComment.do">
...
<div class="comment">
	<form action="dpdeleteComments.do" method="post">
